...
LSPR_peak_time_ranges = [(70,130), (240,300), (395,455), (545,605), (690,750), (820,880), (1050,1110)] # corresponding times for concentrations (values from plot)
LSPR_peak_means = []
...
facecolors = ['b','b','b','b','b','b','r']
for i in range(len(LSPR_peak_time_ranges)):
    axs.fill_betweenx((761,767), LSPR_peak_time_ranges[i][0], LSPR_peak_time_ranges[i][1], facecolor=facecolors[i], alpha=0.3)
