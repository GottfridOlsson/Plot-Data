...
readJSONFilePathStringTEMP = "processedSimulatedSdata_IallCoils_sameKfactor6"  #"S_measurements_time_Xvel_sigma5_20220428" #"COMSOL_designPlot" #"COMSOL_L" #"COMSOL_k-factor" # 
 #   #" "DX_stage2"#
